...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogProxy.modified_date'
        db.add_column('mezzanine_recipes_blogproxy', 'modified_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogProxy.modified_date'
        db.delete_column('mezzanine_recipes_blogproxy', 'modified_date')
