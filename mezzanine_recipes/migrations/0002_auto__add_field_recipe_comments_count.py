...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipe.comments_count'
        db.add_column('mezzanine_recipes_recipe', 'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipe.comments_count'
        db.delete_column('mezzanine_recipes_recipe', 'comments_count')
