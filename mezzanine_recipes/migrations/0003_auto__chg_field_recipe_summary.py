...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mezzanine_recipes_recipe', 'summary', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Recipe.summary'
        db.alter_column('mezzanine_recipes_recipe', 'summary', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    models = {
        ...
        'mezzanine_recipes.recipe': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'Recipe', '_ormbases': ['pages.Page']},
